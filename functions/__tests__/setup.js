...
const mockFirestore = { doc: jest.fn(() => mockDocRef), collection: jest.fn(() => mockCollectionRef), batch: jest.fn(() => ({ set: jest.fn(), update: jest.fn(), delete: jest.fn(), commit: jest.fn(() => Promise.resolve()) })) };
...
module.exports = { mockFirestore, mockDocRef, mockCollectionRef, mockGet, mockSet, mockAdd, mockQueryChain };
