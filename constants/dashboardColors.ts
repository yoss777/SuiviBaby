  ...
  if (scheme === "dark") {
    return {
      ...
      sommeil: {
        ...
        lavender: "#c084fc",
        navy: "#818cf8",
        gradientStart: "#1e1b2e",
        gradientEnd: "#1f2937",
        gridLine: "rgba(167, 139, 250, 0.12)",
        emptyBar: "#374151",
        iconBadgeBg: "rgba(167, 139, 250, 0.15)",
        navButtonBg: "#374151",
        metricBg: "#374151",
        metricHighlightBg: "rgba(167, 139, 250, 0.15)",
        metricHighlightBorder: "rgba(167, 139, 250, 0.3)",
        tooltipBg: "#1f2937",
        tooltipBorder: "#4b5563",
        insightBg: "rgba(167, 139, 250, 0.1)",
        insightText: "#c4b5fd",
        qualityPaisible: "#4ade80",
        qualityAgite: "#fbbf24",
        qualityMauvais: "#f87171",
        locationLit: "#a78bfa",
        locationCododo: "#818cf8",
        locationPoussette: "#c084fc",
        locationVoiture: "#6366f1",
        locationAutre: "#9ca3af",
      },
    };
  }
  return {
    ...
    sommeil: {
      ...
      navButtonBg: "#f5f3ff",
      metricBg: "#f9f7ff",
      metricHighlightBg: "#ede9fe",
      metricHighlightBorder: "#c4b5fd",
      tooltipBg: "#ffffff",
      tooltipBorder: "#e5ecf2",
      insightBg: "#f0ebff",
      insightText: "#5b21b6",
      qualityPaisible: "#22c55e",
      qualityAgite: "#eab308",
      qualityMauvais: "#ef4444",
      locationLit: "#7c3aed",
      locationCododo: "#6366f1",
      locationPoussette: "#a78bfa",
      locationVoiture: "#4f46e5",
      locationAutre: "#9ca3af",
    },
  };
}
