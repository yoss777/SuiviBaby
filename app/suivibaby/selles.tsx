...
export default function SellesScreen({ selles }: Props) {
  ...
  useEffect(() => {
    ...
    if (!autoLoadMore && sellesLoaded && groupedSelles.length === 0 && hasMore) {
      setAutoLoadMore(true);
      setAutoLoadMoreAttempts(0);
    }
  }, [
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      Alert.alert("Erreur", "Impossible de supprimer la selle. Veuillez réessayer.");
    } finally {
      setIsSubmitting(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <ConfirmModal
          ...
          title="Suppression"
          message="Voulez-vous vraiment supprimer cette selle ?"
