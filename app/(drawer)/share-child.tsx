        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.methodDescription}>
              Générez un code à partager par SMS, WhatsApp ou autre. Valide pendant 7 jours.
            </Text>
            ...
            {shareCode ? (
              <View style={styles.codeContainer}>
                ...
                <Text style={styles.codeHelper}>
                  L'autre parent devra aller dans "Ajouter un enfant" puis "J'ai un code"
                </Text>
              </View>
            ) : (
              <TouchableOpacity
                style={[styles.generateButton, isLoadingCode && styles.buttonDisabled]}
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.methodDescription}>
              Invitez directement un autre parent en saisissant son adresse email.
            </Text>
            ...
            <View style={styles.inviteForm}>
              ...
              <TouchableOpacity
                style={[styles.inviteButton, isLoadingInvite && styles.buttonDisabled]}
              ...
              <Text style={styles.inviteHelper}>
                L'autre parent recevra une notification dans l'app et pourra accepter l'invitation
              </Text>
            </View>
          </View>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Les deux parents auront un accès complet au suivi de l'enfant. Vous pourrez retirer l'accès à tout moment depuis les paramètres.
            </Text>
          </View>
        </ScrollView>
      </SafeAreaView>
